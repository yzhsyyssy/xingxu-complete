<template>
  <view class="login-container">
    ...
    <view class="header-section">
      <text class="title">登录星叙</text>
      <text class="subtitle">探索你的星空之旅</text>
    </view>
    ...
    <view class="login-window">
      ...
      <button class="login-btn" @click="handleLogin">进入星叙</button>
      <text v-if="errorMsg" class="error-msg">{{ errorMsg }}</text>
    </view>

    <!-- 底部区域 -->
    <view class="footer">
      <text class="register-link" @click="handleToRegister">没有账号？去注册</text>
...
// 跳转注册
const handleToRegister = () => uni.navigateTo({ url: '/pages/register/index' })
</script>
